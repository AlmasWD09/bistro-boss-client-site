...
const AddItems = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (res.data.success) {
            ...
            // 
            const menuRes = await axiosSecure.post('/menu/api/create', menuItem);
            ...
            <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        ...
                        <textarea placeholder="Recipe Details..." {...register("recipe")} className="block resize-none px-4  mt-2 w-full text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"></textarea>
                    </div>
                    {/* file uploade */}
                    <div>
                    ...
                    <div className="flex justify-end mt-6">
                        <button className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600 flex items-center">Add Items<MdRestaurant /></button>
                    </div>
                </form>
            </section>
